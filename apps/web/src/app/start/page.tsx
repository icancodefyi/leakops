...
const steps = [
  { step: "1", label: "Source", sub: "Where found" },
  { step: "2", label: "Trace", sub: "Mock agents" },
  { step: "3", label: "Report", sub: "Takedown ready" },
];
  ...
  return (
    <div className="min-h-screen bg-white">
      <header className="flex items-center gap-3 border-b border-[#f0ede8] px-6 py-4">
        ...
        <Link href="/supported-platforms" className="ml-auto text-[12px] font-medium text-[#6b7280] transition-colors hover:text-[#0a0a0a]">
          Supported platforms
        </Link>
      </header>
      ...
      <main className="mx-auto max-w-3xl px-6 py-16">
        <div className="mb-10 text-center">
          <p className="mb-4 font-mono text-[11px] uppercase tracking-widest text-rose-500">MMS leak response</p>
          <h1 className="serif-title mx-auto mb-4 max-w-2xl text-4xl leading-snug text-[#0a0a0a]">
            Start an MMS takedown investigation.
          </h1>
          <p className="mx-auto max-w-xl text-[14px] leading-7 text-[#6b7280]">
            A Sniffer-style flow focused only on MMS and NCII leaks: record the source, trace the spread, and generate a takedown-ready report.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-4">
            ...
            <div className="flex items-start gap-5">
              ...
              <div className="min-w-0 flex-1">
                <div className="mb-1.5 flex items-center gap-2.5">
                  <p className="text-[17px] font-semibold tracking-tight text-[#0a0a0a]">MMS leak discovery</p>
                ...
                <p className="mb-4 text-[13.5px] leading-relaxed text-[#6b7280]">
                  The core Sniffer flow, simplified for demo: source platform, evidence upload, agent scan, report, takedown.
                </p>
                <div className="flex flex-wrap gap-2">
                  {["Visual trace", "Route intelligence", "Removal console", "Gmail handoff"].map((feature) => (
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <Link href="/supported-platforms" className="rounded-2xl border border-dashed border-[#e8e4de] bg-[#fafaf8] p-5 transition-all hover:border-[#9ca3af] hover:bg-white">
              <p className="text-[13.5px] font-semibold tracking-tight text-[#374151]">Supported platforms</p>
              <p className="mt-1 text-[12px] leading-relaxed text-[#9ca3af]">Browse the mocked route registry used by the agents.</p>
            </Link>
            <Link href="/report/LO-23891" className="rounded-2xl border border-dashed border-[#e8e4de] bg-[#fafaf8] p-5 transition-all hover:border-[#9ca3af] hover:bg-white">
              <p className="text-[13.5px] font-semibold tracking-tight text-[#374151]">Open demo report</p>
              <p className="mt-1 text-[12px] leading-relaxed text-[#9ca3af]">Skip the scan and view a fully populated mock report.</p>
            </Link>
          </div>
        </div>
      </main>
